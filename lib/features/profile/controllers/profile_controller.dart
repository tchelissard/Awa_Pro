...
class ProfileController extends GetxController implements GetxService{
  ...
  Future<Response> updateProfile( String firstName, String lastName, String email, String identityNumber) async {
    isLoading = true;
    update();
    Response? response = await profileServiceInterface.updateProfileInfo(
        ...
        identityNumber,
        Get.find<AuthController>().pickedProfileFile,Get.find<AuthController>().multipartList
    );
    if(response!.statusCode == 200){
      Get.back();
