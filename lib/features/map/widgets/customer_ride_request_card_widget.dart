              ...
              return Padding(
                ...
                Row(children: [
                  Expanded(child: ButtonWidget(
                    ...
                    onPressed: (){
                      if(bidOn && rideRequest.fareBiddings != null &&
                        ...
                        Get.find<RideController>().tripAcceptOrRejected(rideRequest.id!, 'rejected')
                            .then((value){
                          if(value.statusCode == 200){
                            Get.find<RideController>().getPendingRideRequestList(1);
                            if(fromList){
                  ...
                  Expanded(child: ButtonWidget(
                    ...
                    radius: Dimensions.paddingSizeSmall,
                    onPressed: () async{
                      Get.find<RideController>().tripAcceptOrRejected(rideRequest.id!, 'accepted')
                          .then((value) async {
                        if(value.statusCode == 200){
                          Get.find<AuthController>().saveRideCreatedTime();
                          if(fromList){
